...
const CalendarIcon = () => (
  <Svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#3b82f6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <Path d="M8 2v4" />
    <Path d="M16 2v4" />
    <Path d="rect x=3 y=4 width=18 height=18 rx=2" />
    <Path d="M3 10h18" />
    <Path d="M8 14h.01" />
    <Path d="M12 14h.01" />
    <Path d="M16 14h.01" />
...
export const EventPlannerPDF = ({ markdown }: Props) => {
        ...
        <View style={styles.header} fixed>
          <View style={styles.headerLeft}>
            ...
            <View>
              ...
              <Text style={styles.headerSubtitle}>Etkinlik ve Kutlama Programı</Text>
            </View>
          </View>
          <View style={styles.headerRight}>
            <Text style={styles.documentType}>PROGRAM TASLAĞI</Text>
