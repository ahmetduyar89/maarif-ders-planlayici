...
import { DifferentiatedInstructionPDF } from './DifferentiatedInstructionPDF';
import MarkdownEditor from './MarkdownEditor';

interface DifferentiatedInstructionOutputProps {
  instructionContent: string;
  onReset?: () => void;
}

export default function DifferentiatedInstructionOutput({ instructionContent: initialContent, onReset }: DifferentiatedInstructionOutputProps) {
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            onClick={async () => {
              ...
              exportToWord(content, 'farklilastirilmis-ogretim-plani', 'Farklılaştırılmış Öğretim Planı');
            }}
          ...
          <PDFDownloadLink
            document={<DifferentiatedInstructionPDF markdown={content} />}
            fileName="farklilastirilmis-ogretim-plani.pdf"
