...
export const UnitPlanPDF = ({ markdown }: { markdown: string }) => {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={{ alignItems: 'center', marginBottom: 20 }} fixed>
          ...
          <Text style={{ fontSize: 14, fontWeight: 'bold', textAlign: 'center', marginTop: 10, textDecoration: 'underline' }}>ÜNİTE PLANI</Text>
        </View>
