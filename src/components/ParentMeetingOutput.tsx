...
import { ParentMeetingPDF } from './ParentMeetingPDF';
import MarkdownEditor from './MarkdownEditor';

interface ParentMeetingOutputProps {
  meetingContent: string;
  onReset?: () => void;
}

export default function ParentMeetingOutput({ meetingContent: initialContent, onReset }: ParentMeetingOutputProps) {
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            onClick={async () => {
              ...
              exportToWord(content, 'veli-gorusme-raporu', 'Veli Görüşme Raporu');
            }}
          ...
          <PDFDownloadLink
            document={<ParentMeetingPDF markdown={content} />}
            fileName="veli-gorusme-raporu.pdf"
