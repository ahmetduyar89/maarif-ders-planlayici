...
export const DebatePDF = ({ markdown }: Props) => {
        ...
        <View style={styles.header} fixed>
          <View style={styles.headerLeft}>
            ...
            <View>
              ...
              <Text style={styles.headerSubtitle}>Sınıf İçi Tartışma / Münazara Planı</Text>
            </View>
          </View>
          <View style={styles.headerRight}>
            <Text style={styles.documentType}>TARTIŞMA PLANI</Text>
