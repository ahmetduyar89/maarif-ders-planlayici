...
import { StorytellingPDF } from './StorytellingPDF';
...
export default function StorytellingOutput({ storyContent: initialContent, onReset }: StorytellingOutputProps) {
    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            onClick={async () => {
              ...
              exportToWord(content, 'egitici-hikaye', 'Eğitici Hikaye');
            }}
          ...
          <PDFDownloadLink
            document={<StorytellingPDF markdown={content} />}
            fileName="egitici-hikaye.pdf"
      ...
      <div className="p-8 md:p-12 max-w-4xl mx-auto bg-white dark:bg-slate-900 print:p-0">
        {isEditing ? (
          ...
          <div className="prose prose-slate dark:prose-invert prose-purple max-w-none prose-headings:font-bold prose-h1:text-3xl prose-h1:text-center prose-h1:mb-8 prose-h1:border-b-2 prose-h1:border-slate-800 dark:prose-h1:border-slate-200 prose-h1:pb-6 prose-h2:text-2xl prose-h2:text-purple-700 dark:prose-h2:text-purple-400 prose-h2:mt-10 prose-h2:border-b prose-h2:border-slate-200 dark:prose-h2:border-slate-700 prose-h2:pb-2 prose-h3:text-xl prose-h3:text-slate-800 dark:prose-h3:text-slate-100 prose-h3:mt-8 prose-li:my-1">
