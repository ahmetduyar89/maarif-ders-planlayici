...
import { ProjectTaskPDF } from './ProjectTaskPDF';
import MarkdownEditor from './MarkdownEditor';

interface ProjectTaskOutputProps {
  projectTaskContent: string;
  onReset?: () => void;
}

export default function ProjectTaskOutput({ projectTaskContent: initialContent, onReset }: ProjectTaskOutputProps) {
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button
            onClick={async () => {
              ...
              exportToWord(content, 'proje-performans-odevi', 'Proje ve Performans Ödevi');
            }}
          ...
          <PDFDownloadLink
            document={<ProjectTaskPDF markdown={content} />}
            fileName="proje-performans-odevi.pdf"
